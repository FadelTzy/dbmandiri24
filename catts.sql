...
-- Dumping data for table cat3.category_courses: ~840 rows (approximately)
...
-- Dumping data for table cat3.exams: ~280 rows (approximately)
...
-- Dumping data for table cat3.questions_b: ~360 rows (approximately)
...
-- Dumping data for table cat3.server_details: ~280 rows (approximately)
...
-- Dumping data for table cat3.sesis: ~8 rows (approximately)
...
-- Dumping data for table cat3.students: ~0 rows (approximately)
...
-- Dumping data for table cat3.teachers: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17301 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table cat3.users: ~0 rows (approximately)
INSERT INTO `users` (`id`, `role_id`, `name`, `username`, `email`, `email_verified_at`, `password`, `remember_token`, `ip_address`, `created_at`, `updated_at`) VALUES
	(12669, 4, 'Gedung Pinisi Lt. 2 & 3 UNM Gunungsari Baru', 'UNMC4T01', NULL, NULL, '$2a$12$lvj0Af1ChGz8pc9Ln9SGwOWKWDehSiQh5.MNeUCRkg79QCtjNiDru', NULL, '127.0.0.1', '2024-06-29 20:56:51', '2024-06-30 10:30:50'),
